      ...
      >
        <div className="nity-section-container">
          ...
          <div className="nity-social-links">
            <Link to="#" className="andy-social-link laptop-instagram">
              <svg
            ...
            <Link to="#" className="andy-social-link laptop-twitter">
            ...
            <Link to="https://www.linkedin.com/in/vinijaiswal/" className="andy-social-link laptop-linkedin">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="#e6c068" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <Link to="#" className="andy-social-link laptop-youtube">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="#e6c068" xmlns="http://www.w3.org/2000/svg">
                <path
